...
# create name vector
listnames<-names(county_age_maps_list)
mapnames<-paste0(listnames, "_age_map")

# inputlist
inputlist<-list(county_age_maps_list, mapnames, ".png")

# writes png files
pmap(inputlist, map_to_write)

# inputlist
inputlist<-list(county_age_maps_list, mapnames, ".jpeg")
